...
public class DiscoverController {
    ...
    public ResponseEntity<Response> discoverHomePageBsTeam(@RequestParam(required = false) String region,
                                                   @RequestParam(required = false) Integer trophies,
                                                   @RequestParam(required = false) Integer threeVThreeWins,
                                                   @RequestParam(required = false) Integer twoVTwoWins,
                                                   @RequestParam(required = false) Integer soloWins,
        ...
        //Create team using createTeam method in bsTeamService
        Response response = discoverService.discoverHomePageBsTeam(username, region, trophies, threeVThreeWins,
                twoVTwoWins, soloWins, pageSize, pageNumber);
    ...
    public ResponseEntity<Response> discoverHomePageBsProfile(@RequestParam(required = false) String region,
                                                      @RequestParam(required = false) String language,
                                                      @RequestParam(required = false) Integer trophies,
                                                      @RequestParam(required = false) Integer threeVThreeWins,
                                                      @RequestParam(required = false) Integer twoVTwoWins,
        ...
        //Create team using createTeam method in bsTeamService
        Response response = discoverService.discoverHomePageBsProfile(username, region, language, trophies, threeVThreeWins,
                twoVTwoWins, soloWins, pageSize, pageNumber);
